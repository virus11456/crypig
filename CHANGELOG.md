...
### 2026-09-19（Stocktools 美股匯損交叉導覽）

- 頂部與頁尾既有「相關工具」列新增「美股匯損」，連到 https://www.stocktools.cc/tw/us-fx。既有手續費／ETF／入金／開戶／配息／第一次買美股／盤前盤後／市價／限價／ADR 深鏈與 OKX／Pionex 開戶 CTA 不變。不加入 Firstrade／金融聯盟連結，不更動交易／訊號邏輯。
...
### 2026-09-19（Stocktools 美股盤前盤後交叉導覽）

- 頂部與頁尾既有「相關工具」列新增「美股盤前盤後」，連到 https://www.stocktools.cc/tw/us-premarket。既有手續費／ETF／入金／開戶／配息／第一次買美股深鏈與 OKX／Pionex 開戶 CTA 不變。不加入 Firstrade／金融聯盟連結，不更動交易／訊號邏輯。

### 2026-09-19（Stocktools 第一次買美股交叉導覽）

- 頂部與頁尾既有「相關工具」列新增「第一次買美股」，連到 https://www.stocktools.cc/tw/us-first-buy。既有手續費／ETF／入金／開戶／配息深鏈與 OKX／Pionex 開戶 CTA 不變。不加入 Firstrade／金融聯盟連結，不更動交易／訊號邏輯。

### 2026-09-19（Stocktools 美股配息交叉導覽）

- 頂部與頁尾既有「相關工具」列新增「美股配息」，連到 https://www.stocktools.cc/tw/us-dividend。既有手續費／ETF／入金／開戶深鏈與 OKX／Pionex 開戶 CTA 不變。不加入 Firstrade／金融聯盟連結，不更動交易／訊號邏輯。
...
- 頂部導覽在 SIMPLES 其他工具旁加入「OKX 開戶」「派網開戶」各一則，沿用既有 sibling 文字連結樣式，另開分頁。頁尾不重複。不更動交易／訊號邏輯。
